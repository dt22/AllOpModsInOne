...
namespace AllOpModsInOne
{
    internal class PromoSkinArmor
    {
        ...
        public static void Create_PromoSkinArmor()
        {
            ...
            {
                if (ability.name.Contains("Acheron_RestorePandoranArmor_AbilityDef"))
                {
            ...
            foreach (TacticalAbilityDef ability in Repo.GetAllDefs<TacticalAbilityDef>())
            {
                if (ability.name.Contains("Oilcrab_Die_DeathBelcher_AbilityDef"))
                {
        ...
        public static void AddAbilities()
        {
            ...
            if (MyMod.Config.GoldArmorSkinsHaveSpecialAbilities)
            {
                ...
                foreach (TacticalAbilityDef ability in Repo.GetAllDefs<TacticalAbilityDef>())
                {
                    if (ability.name.Contains("ViralAreaAttack_ApplyDamageEffect_AbilityDef"))
                    {
